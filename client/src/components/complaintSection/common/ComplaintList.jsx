                    ...
                    {complaint.assignedName && (
                      <>
                        ...
                        {complaint.assignedContact && (
                          <p className="text-sm text-gray-600">
                            <span className="font-medium">Contact:</span> {complaint.assignedContact}
                          </p>
                        )}
                      </>
                    )}
                  </div>
                  <p className="text-sm text-gray-700 mb-4 line-clamp-2">Description: {complaint.description}</p>
